...
ActiveRecord::Schema.define(version: 2019_09_21_033221) do
  ...
  create_table "plans", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["plan_device_id_id"], name: "index_plans_on_plan_device_id_id"
  ...
  add_foreign_key "plans", "plans_devices", column: "plan_device_id_id"
